...
| [`step16/`](step16/) | GoodWe Integration Refactor – nový GoodWeManager, reader/writer bez kolizí, SDG do role logger | 🚧 S06 implementace dokončena, review otevřeno <!-- status: IN_PROGRESS --> |
